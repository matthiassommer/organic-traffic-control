 ...
 *
 * Assures that the flow orderings (the situation's dimensions) of a {@link Situation}
 * corresponds to the flows passed in the {@link XCSIC#selectAction(float[], int)}-method
 *
 * @author rauhdomi
 */
