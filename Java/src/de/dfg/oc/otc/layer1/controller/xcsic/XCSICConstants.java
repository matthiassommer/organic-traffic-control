 ...
 *         sämtlicher für das XCSIC notwendige Parameter zur Verfügung.
 * @author Anthony Stein
 * @author Dominik Rauh
 */

public final class XCSICConstants {
    ...
    static {
        File baseFile = new File(XCSICConstants.class.getProtectionDomain().getCodeSource().getLocation().getPath());
    ...
    private XCSICConstants() {
    }

    private static void generateNewFolderNames() {
