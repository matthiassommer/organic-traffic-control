...
import de.dfg.oc.otc.layer1.controller.xcscic.interpolation.algorithms.ext_src.liang_hale.mesh.TriMesh;
...
public class SibsonInterpolator2 {
    ...
    Method method, float[] f, float[] x1, float[] x2) 
  {
    ...
    public SibsonInterpolator2(
            Method method, TriMesh triangulation)
    {
        _mesh = triangulation;
        _nodeList = new TriMesh.NodeList();
        _triList = new TriMesh.TriList();
...
//  }
  ...
  public HashMap<TriMesh.Node, Double> getOverlapAreasOfNaturalNeighbors(float x1, float x2) {

      HashMap<TriMesh.Node, Double> naNeOverlap = new HashMap<TriMesh.Node, Double>();
