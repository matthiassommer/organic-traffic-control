...
public class Classifier implements Cloneable, Comparable<Classifier> {
    ...
    private final de.dfg.oc.otc.layer1.controller.xcscic.ClassifierCondition condition;
     ...
     */
    Classifier(final de.dfg.oc.otc.layer1.controller.xcscic.ClassifierCondition condition,
     ...
     * @param prediction the prediction
     */
    public Classifier(final float[] situation,
                      final TrafficLightControllerParameters tlcParam,
                      final float prediction) {
        initConstants();
        this.maxFlow = tlcParam.getMaxSignalGroupFlowForDegreeOfSaturation(1);

        this.condition = new de.dfg.oc.otc.layer1.controller.xcscic.ClassifierCondition(situation,
    ...
    public final Classifier clone() {
        final de.dfg.oc.otc.layer1.controller.xcscic.ClassifierCondition clonedCondition = this.condition.clone();
    ...
    public final TrafficLightControllerParameters getAction() {
        return action;
    }
    ...
    final float getKappa() {
        ...
        return new Double(constants.getAlpha()
                * FastMath.pow(predictionError / constants.getEpsilonZero(), -1
                * constants.getNy())).floatValue();
    }

    public final int getNumerosity() {
        return numerosity;
    }

    public final void setNumerosity(final int numerosity) {
        this.numerosity = numerosity;
    }

    public final float getPrediction() {
        return rewardPrediction;
    }

    public final ClassifierCondition getCondition() {
    ...
    public final void setCreatedBy(final Creator createdBy) {
    ...
    public final float getPredictionError() {
        return this.predictionError;
    }

    public final void setPredictionError(final float predictionError) {
    ...
    public final String toString() {
        ...
        } else if (this.createdBy == Creator.IC) {
            createdBy += Creator.IC;
        } else {
     ...
     * optimization), by the LCS (through widening) or by the InterpolationComponent(IC).
     */
    public enum Creator {
        EvoAlg, LCS, IC, TMP
    }
