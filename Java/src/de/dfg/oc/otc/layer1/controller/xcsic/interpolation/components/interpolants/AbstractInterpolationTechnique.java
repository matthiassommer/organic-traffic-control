...
public abstract class AbstractInterpolationTechnique
{
    ...
    // Die Menge aller bekannter Stützstellen, die für die Interpolation herangezogen werden können.
    protected Set<Situation> samplingPoints = new LinkedHashSet<>();
     ...
     */
    public abstract InterpolationValue interpolate(Situation situation) throws InterpolationComponentException;
    ...
    public Set<Situation> getSamplingPoints() { return samplingPoints; }
}
