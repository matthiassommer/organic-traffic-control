 ...
 * @author rauhdomi
 *
 * Generic interface for the resulting value of an interpolation;
 * mainly used by {@see AbstractInterpolationTechnique#getInterpolatedValue()}
 * Every InterpolationValue shall implement this interface
 *
 */
public interface InterpolationValue { }
