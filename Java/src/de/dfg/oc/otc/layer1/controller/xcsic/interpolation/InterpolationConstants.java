...
import de.dfg.oc.otc.layer1.controller.xcsic.interpolation.components.interpolants.InterpolantType;
 ...
 * <p>
 * Die Konfigurationsdatei für die Interpolations-Komponente {@link de.dfg.oc.otc.layer1.controller.xcsic.interpolation.InterpolationComponent}.
 * Konstanten können in der interpolation_component.properties angepasst werden.
 * </p>
 */
public final class InterpolationConstants {
    ...
    private static final String CONSTANTS_PROPERTIES_FILENAME = "xcsic_interpolation_component.properties";
    ...
    private static final String WARM_UP_SAMPLING_POINTS_KEY = "warm_up_sampling_points";
    ...
    //** Soll während des warm-ups des XCSIC Stützstellen zur Interpolante hinzugefügt werden */
    private static final boolean DEFAULT_WARM_UP_SAMPLING_POINTS = true;
    ...
    //** Soll während des warm-ups des XCSIC Stützstellen hinzugefügt werden */
    public static final boolean WARM_UP_SAMPLING_POINTS;
    //** Wie hoch soll der Exponent der IDW-Interpolante sein */
    ...
    static {
        ...
        WARM_UP_SAMPLING_POINTS = isWarmUpSamplingPoints();
        ASI = isAsi();
        IDW_EXPO = getIdwExpo();
        tau_tax = getTauTax();
    ...
    private static boolean loadConstantsProperties() {
        ...
        try (InputStream in = new FileInputStream(BASE_PATH + File.separator + CONSTANTS_PROPERTIES_FOLDER + File.separator + CONSTANTS_PROPERTIES_FILENAME)) {
    ...
    private static void loadConstantsPropertiesDefaults() {
        ...
        constantsProperties.setProperty(WARM_UP_SAMPLING_POINTS_KEY, Boolean.toString(DEFAULT_WARM_UP_SAMPLING_POINTS));
    ...
    private static void storeConstantsProperties() {
        ...
        constantsProperties.setProperty(WARM_UP_SAMPLING_POINTS_KEY, Boolean.toString(WARM_UP_SAMPLING_POINTS));
        ...
        try (OutputStream out = new FileOutputStream(BASE_PATH + File.separator + CONSTANTS_PROPERTIES_FOLDER + File.separator + CONSTANTS_PROPERTIES_FILENAME)) {
    ...
    private static boolean isWarmUpSamplingPoints() {
        return Boolean.parseBoolean(constantsProperties.getProperty(WARM_UP_SAMPLING_POINTS_KEY));
    }
