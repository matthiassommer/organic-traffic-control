...
public class Classifier implements Cloneable, Comparable<Classifier> {
    ...
    private final de.dfg.oc.otc.layer1.controller.xcsic.ClassifierCondition condition;
     ...
     */
    Classifier(final de.dfg.oc.otc.layer1.controller.xcsic.ClassifierCondition condition,
    ...
    Classifier(final float[] situation,
        ...
        this.condition = new de.dfg.oc.otc.layer1.controller.xcsic.ClassifierCondition(situation,
    ...
    public final Classifier clone() {
        final de.dfg.oc.otc.layer1.controller.xcsic.ClassifierCondition clonedCondition = this.condition.clone();
