 ...
 * @author rauhdomi
 *
 * Used to create all available interpolants. Serves as a kind of factory.
 *
 */
public class InterpolantFactory {

    private InterpolantFactory() {}

    public static AbstractInterpolationTechnique newInterpolant(InterpolantType type)
    {
        return type.create();
    }
}
