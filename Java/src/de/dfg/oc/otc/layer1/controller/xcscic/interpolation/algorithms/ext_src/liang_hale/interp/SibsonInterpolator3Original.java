 ...
 * @version 2009.06.14
 */
public class SibsonInterpolator3Original {
   ...
   */
  public SibsonInterpolator3Original(float[] x1, float[] x2, float[] x3) {
   ...
   * @param x3 array of sample x3 coordinates.
   */
  public SibsonInterpolator3Original(float[] f, float[] x1, float[] x2, float[] x3) {
   ...
   * @param x3 array of sample x3 coordinates.
   */
  public SibsonInterpolator3Original(
