...
/**
 * Created by dmrauh on 18.02.15.
 *
 * @author rauhdomi
 *
 * Holds the interpolated color as a result of an interpolation regarding the checker board problem
 */
public class CheckerBoardValue implements InterpolationValue {
    protected Color interpolatedColor;

    public CheckerBoardValue(Color interpolatedColor) {
