...
import de.dfg.oc.otc.layer1.controller.xcscic.interpolation.components.adjustment.AdjustmentComponent;
import de.dfg.oc.otc.layer1.controller.xcscic.interpolation.components.evaluation.EvaluationComponent;
import de.dfg.oc.otc.layer1.controller.xcscic.interpolation.components.interpolants.AbstractInterpolationTechnique;
import de.dfg.oc.otc.layer1.controller.xcscic.interpolation.components.interpolants.InterpolantFactory;
...
public class InterpolationComponent {
    ...
    private AbstractTLCSelector correspondingxcscic;
    ...
    public void initInterpolationComponent()
    {
        ...
        this.evaluationComp = new EvaluationComponent(this.interpolant, this.evaluationFilePath,
                correspondingxcscic.getAttribute().getMaximalValue());
     ...
     */
    public InterpolationValue interpolate(Situation situation, ClassifierSet population)
    {
        try
        {
            return this.interpolant.interpolate(situation, population);
        }
     ...
     * {@see components.interpolants.AbstractInterpolationTechnique}
     *
    ...
    private void writeConstants()
    {
        ...
        try
        {
            FileOutputStream fOS = new FileOutputStream(filePathWithoutExtension
                    ...
                    + "." + filePathExtension);
            OutputStreamWriter oSW = new OutputStreamWriter(fOS, XCSCICConstants.OUT_FILE_CHARSET);
            pW = new PrintWriter(oSW);
        }
        catch(Exception e){ System.out.println("Mistake in create file Writers! " + e); }

        pW.println("iota" + ";" + "tau" + ";" + "p_max" + ";"
                + "t_window" + ";"+ "interpolant" + ";" + "asi" + ";" + "ic_covering" + ";"
                + "always_exec_ic_action" + ";" + "ignore_trust_level" + ";"
                + "add_covered_to_pop" + ";" + "idw_expo");
        pW.println(InterpolationConstants.iota_incentive + ";"
                ...
                + InterpolationConstants.ALWAYS_EXECUTE_INTERPOLATED_ACTION + ";"
    ...
    public void setCorrespondingXCSCIC(AbstractTLCSelector xcscic) {
        this.correspondingxcscic = xcscic;
    }
