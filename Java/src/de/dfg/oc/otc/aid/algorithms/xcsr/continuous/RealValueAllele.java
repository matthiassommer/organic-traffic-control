 ...
 */
public class RealValueAllele {
    private double lowerBound;
    private double upperBound;
    private double center;
    private double spread;

    public RealValueAllele(double first, double last, AlleleRepresentations representation) {
    ...
    private void shrinkToBounds() {
        ...
        if (XCSRConstants.usedGeneRepresentation == AlleleRepresentations.CENTER_SPREAD) {
            double endpoint_right = this.center + this.spread;
            double endpoint_left = this.center - this.spread;

            if (endpoint_left < XCSRConstants.minPhenotypeValue) {
                shrinkNecessary = true;
                endpoint_left = XCSRConstants.minPhenotypeValue;
            } else if (endpoint_left > XCSRConstants.maxPhenotypeValue) {
                shrinkNecessary = true;
                endpoint_left = XCSRConstants.maxPhenotypeValue;
            }

            if (endpoint_right < XCSRConstants.minPhenotypeValue) {
                shrinkNecessary = true;
                endpoint_right = XCSRConstants.minPhenotypeValue;
            } else if (endpoint_right > XCSRConstants.maxPhenotypeValue) {
                shrinkNecessary = true;
                endpoint_right = XCSRConstants.maxPhenotypeValue;
            }
            ...
            if (this.lowerBound < XCSRConstants.minPhenotypeValue) {
                shrinkNecessary = true;
                this.lowerBound = XCSRConstants.minPhenotypeValue;
            } else if (this.lowerBound > XCSRConstants.maxPhenotypeValue) {
                shrinkNecessary = true;
                this.lowerBound = XCSRConstants.maxPhenotypeValue;
            }

            if (this.upperBound < XCSRConstants.minPhenotypeValue) {
                shrinkNecessary = true;
                this.upperBound = XCSRConstants.minPhenotypeValue;
            } else if (this.upperBound > XCSRConstants.maxPhenotypeValue) {
                shrinkNecessary = true;
                this.upperBound = XCSRConstants.maxPhenotypeValue;
            }
