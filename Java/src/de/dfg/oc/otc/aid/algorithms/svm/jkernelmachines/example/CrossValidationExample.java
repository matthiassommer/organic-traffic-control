...
import de.dfg.oc.otc.aid.algorithms.svm.jkernelmachines.classifier.NystromLSSVM;
...
import de.dfg.oc.otc.aid.algorithms.svm.jkernelmachines.evaluation.RandomSplitCrossValidation;
import de.dfg.oc.otc.aid.algorithms.svm.jkernelmachines.io.ArffImporter;
 ...
 *	<li>-a algorithm: type of SVM algorithm(jkernelmachines, lasvmi, smo, nlssvm default jkernelmachines)</li>
...
public class CrossValidationExample {
	...
	public static void main(String[] args) {
		...
		RandomSplitCrossValidation<double[]> cv = new RandomSplitCrossValidation<double[]>(svm, list, ev);
		cv.setNbTest(nbtest);
	...
	private static void printHelp() {
		...
		System.out
				.println("\t-a algorithm: type of SVM algorithm(jkernelmachines, lasvmi, smo, default jkernelmachines)");
		System.out
