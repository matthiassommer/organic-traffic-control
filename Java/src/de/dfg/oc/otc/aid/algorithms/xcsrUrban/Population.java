...
public class Population implements Serializable
{
    ...
    public final XCSRUrbanParameters parameters;

    public Population(XCSRUrbanParameters parameters, int maxSize) {
    ...
    private void deleteClassifier() {
        ...
        double choicePoint = voteSum * this.parameters.drand();
        voteSum = 0.0;
