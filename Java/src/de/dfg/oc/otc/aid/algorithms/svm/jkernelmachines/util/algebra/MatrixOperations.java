...
*/
package de.dfg.oc.otc.aid.algorithms.svm.jkernelmachines.util.algebra;

import static de.dfg.oc.otc.aid.algorithms.svm.jkernelmachines.util.algebra.VectorOperations.addi;
import static de.dfg.oc.otc.aid.algorithms.svm.jkernelmachines.util.algebra.VectorOperations.dot;
import static de.dfg.oc.otc.aid.algorithms.svm.jkernelmachines.util.algebra.VectorOperations.n2;
...
public class MatrixOperations {
	 ...
	 * @return an array of two matrices containing {Q, L}
	 */
	public static double[][][] eig_jacobi(final double[][] m, boolean prec) {
		int n = m.length;
		double[][] matrix;
