...
extern "C" {
	...
	AAPIEXPORT const unsigned short * ECIGetNameControl( int elemControl );
	...
	AAPIEXPORT int ECIChangeParametersGreenMeteringByLaneById(int idmetering,double timeSta,double amax, double ngreenTime, double amin, double ncicleTime, double offset, double YellowTime, double laneOffset);
